...
## Filtering 2: multiple hits, sibgle hits, orientation etc
...
## Filtering 3: control region

Additional filtering: 
1. Mean length of blast hits (like: 'FR dist / n bla' ?)
2. If it’s close to 860 - we accept this read
3. If not - take region between IS and bla, blast it and check if the number of this region corresponds to what distance between FRs suggests (in terms of n bla expected)
4. If all is ok here, accept this read, else trash it
