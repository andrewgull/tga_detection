...
![Fig.1. Plasmid DA61218 and location of control regions](figures/pDA61218_full_size_annotated.png)
...
#| eval: false
#| echo: false
mkdir -p results/tables/CR1/

blastn -query resources/control_regions/CR1.fa -db results/blast_databases/76595_D_mh/blastdb -outfmt 6 -num_threads 8 -num_alignments 900000 > results/tables/CR1/blast_CR1_76595_D_mh.tsv

mkdir -p results/tables/CR2/

blastn -query resources/control_regions/CR2.fa -db results/blast_databases/76595_D_mh/blastdb -outfmt 6 -num_threads 8 -num_alignments 900000 > results/tables/CR2/blast_CR2_76595_D_mh.tsv

mkdir -p results/tables/CR3/

blastn -query resources/control_regions/CR3.fa -db results/blast_databases/76595_D_mh/blastdb -outfmt 6 -num_threads 8 -num_alignments 900000 > results/tables/CR3/blast_CR3_76595_D_mh.tsv

mkdir -p results/tables/CR4/

blastn -query resources/control_regions/CR4.fa -db results/blast_databases/76595_D_mh/blastdb -outfmt 6 -num_threads 8 -num_alignments 900000 > results/tables/CR4/blast_CR4_76595_D_mh.tsv
```
