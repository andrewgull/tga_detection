...
#### Extract one read and blast

```{bash, eval=F}
# extract the read
seqkit grep -p cf14f1cd-68b2-4993-9bd1-3098614683a1 -o notebooks/fasta/read_cnv_5.fa  results/reads_filtered/replicate_e/CNV_reads_all.fasta

# blast it
blastn -query resources/genes/blaSHV.fa -subject notebooks/fasta/read_cnv_5.fa -outfmt 6 > notebooks/tables/blast_blaSHV_read_cnv_5.tsv
```

#### Read the resulting table

```{r, message=FALSE}
blast_gene <- read_delim("tables/blast_blaSHV_read_cnv_5.tsv", col_names = F)
